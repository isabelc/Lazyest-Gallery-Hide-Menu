...
# main config
PLUGINSLUG="lazyest-gallery-hide-menu" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="lazyest-gallery-hide-menu.php" # this should be the name of your main php file in the wordpress plugin
